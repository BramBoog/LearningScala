object Day02 extends App:
    ...
    val ids: List[String] = Source.fromFile("AdventOfCode2018/src/main/resources/InputDay02.txt").getLines.toList
    ...
    println(s"Result part 2: ${sharedCharsAsString}") //mphcuasvrnjzzkbgdtqeoylva
